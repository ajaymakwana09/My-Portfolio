        ...
        <div className="container">
          <div className="row d-flex align-items-center justify-content-center">
            <div className="credentials  d-flex gap-5">
              <div className="credentail-sidebar-wrap " data-aos="fade-up" data-aos-delay="50"
                  ...
                  <div className="container">
                    <div className="row">
                      <div className="credential-content">
                        <div className="credentail-about" data-aos="zoom-in-down" data-aos-delay="50"
                          data-aos-duration="1000">
                          <h3>ABOUT ME</h3>
                        ...
                        <div className="credentail-edu-exp-item credentail-education" data-aos="zoom-out-up" data-aos-delay="50"
                          data-aos-duration="1000">
                          <h3>Education</h3>
                        ...
                        <div className="credentail-edu-exp-item credentail-education" data-aos="zoom-out-up" data-aos-delay="50" data-aos-duration="1000">
                          {/* <h3>Education</h3> */}
                          <div className="credentail-edu-exp">
                            <h5>2022 - 2024</h5>
